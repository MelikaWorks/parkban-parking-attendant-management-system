...
- `1-1_Login_Form.png`
- `2-1_Device_Management.png`
- `3-1_Add_New_Parking_Attendant.png`
- `13-1_Import_Data_From_Excel.png`
- `14_Payroll_Registration.png`
...
![Login Form](screenshots/1-1_Login_Form.png)

---

### Login Form with Access Level
`1-2_Login_Form_With_Access_Level.png`

Login screen displaying different access levels for system users.

![Login Form with Access Level](screenshots/1-2_Login_Form_With_Access_Level.png)
...
![Device Management](screenshots/2-1_Device_Management.png)

---

### Add New Device
`2-2_Add_New_Device.png`

Form used to register a new mobile device, including IMEI, SIM card and serial numbers.

![Add New Device](screenshots/2-2_Add_New_Device.png)
...
![Edit Device](screenshots/2-3_Edit_Device.png)
...
![Add New Parking Attendant](screenshots/3-1_Add_New_Parking_Attendant.png)

---

### Parking Attendant Wizard Button
`3-2_Parking_Attendant_Wizard_Button.png`

Wizard option used for step-by-step registration of a new parking attendant.

![Parking Attendant Wizard Button](screenshots/3-2_Parking_Attendant_Wizard_Button.png)

---

### Parking Attendant Wizard Registration
`3-3_Parking_Attendant_Wizard_Registration.png`

Step-by-step wizard interface for registering a new parking attendant.

![Parking Attendant Wizard Registration](screenshots/3-3_Parking_Attendant_Wizard_Registration.png)

---

### Street Assignment Management
`4-1_Street_Assignment_Management.png`

Module used to assign parking attendants to specific streets and operational areas.

![Street Assignment Management](screenshots/4-1_Street_Assignment_Management.png)

---

### Add Street Assignment
`4-2_Add_Street_Assignment.png`

Form used to assign one or more attendants to a selected street.

![Add Street Assignment](screenshots/4-2_Add_Street_Assignment.png)

---

### Edit Attendance Assignment
`4-3_Edit_Attendance_Assignment.png`

Screen for editing previously registered street attendance assignments.

![Edit Attendance Assignment](screenshots/4-3_Edit_Attendance_Assignment.png)

---

### Attendance Management
`5-1_Attendance_Management.png`

Daily attendance, absence and leave registration screen.

![Attendance Management](screenshots/5-1_Attendance_Management.png)

---

### Edit Attendance
`5-2_Edit_Attendance.png`

Screen used to edit previously registered attendance records.

![Edit Attendance](screenshots/5-2_Edit_Attendance.png)

---

### Attendance Validation
`6_Attendance_Validation.png`

Validation process requiring date entry before attendance registration can continue.

![Attendance Validation](screenshots/6_Attendance_Validation.png)
...
![Print Report](screenshots/7_Print_Report.png)

---

### Export to Excel
`8_Export_To_Excel.png`

Example of exporting data from the system into Microsoft Excel format.

![Export to Excel](screenshots/8_Export_To_Excel.png)

---

### Recharge Management
`9-1_Recharge_Management.png`

Management screen for recharge packages assigned to parking attendants.

![Recharge Management](screenshots/9-1_Recharge_Management.png)

---

### Add Recharge
`9-2_Add_Recharge.png`

Form used to register a new recharge package and related payment amount.

![Add Recharge](screenshots/9-2_Add_Recharge.png)

---

### Edit Recharge
`9-3_Edit_Recharge.png`

Form used to edit previously registered recharge information.

![Edit Recharge](screenshots/9-3_Edit_Recharge.png)

---

### Card Management
`10-1_Card_Management.png`

Screen used to manage card inventory, sales and payment tracking.

![Card Management](screenshots/10-1_Card_Management.png)

---

### Add Card Record
`10-2_Add_Card_Record.png`

Form used to register card delivery, sales and payment information.

![Add Card Record](screenshots/10-2_Add_Card_Record.png)

---

### Edit Card Record
`10-3_Edit_Card_Record.png`

Form used to edit previously registered card-related information.

![Edit Card Record](screenshots/10-3_Edit_Card_Record.png)

---

### Add Advance Payment
`11-1_Add_Advance_Payment.png`

Form used to register an advance payment for a parking attendant.

![Add Advance Payment](screenshots/11-1_Add_Advance_Payment.png)

---

### Edit Advance Payment
`11-2_Edit_Advance_Payment.png`

Form used to edit an existing advance payment record.

![Edit Advance Payment](screenshots/11-2_Edit_Advance_Payment.png)

---

### Add Debt Record
`12-1_Add_Debt_Record.png`

Form used to register a debt or deduction for a parking attendant.

![Add Debt Record](screenshots/12-1_Add_Debt_Record.png)

---

### Edit Debt Record
`12-2_Edit_Debt_Record.png`

Form used to edit a previously registered debt entry.

![Edit Debt Record](screenshots/12-2_Edit_Debt_Record.png)
...
![Import Data From Excel](screenshots/13-1_Import_Data_From_Excel.png)

---

### Import Data From Excel – Step 2
`13-2_Import_Data_From_Excel_Step2.png`

Second step of the Excel import workflow, including temporary table processing.

![Import Data From Excel Step 2](screenshots/13-2_Import_Data_From_Excel_Step2.png)
...
![Payroll Registration](screenshots/14_Payroll_Registration.png)

---

### Parking Attendant Settlement
`15_Parking_Attendant_Settlement.png`

Settlement screen used when a parking attendant leaves the organization.

![Parking Attendant Settlement](screenshots/15_Parking_Attendant_Settlement.png)

---

### Add Office Expense
`16-1_Add_Office_Expense.png`

Form used to register office expenses and operational costs.

![Add Office Expense](screenshots/16-1_Add_Office_Expense.png)

---

### Edit Office Expense
`16-2_Edit_Office_Expense.png`

Form used to edit previously registered office expense records.

![Edit Office Expense](screenshots/16-2_Edit_Office_Expense.png)
...
![Settings](screenshots/17_Settings.png)

---

### Maximized View Display
`18_Maximized_View_Display.png`

Example showing the application's maximized ribbon-style interface.

![Maximized View Display](screenshots/18_Maximized_View_Display.png)
